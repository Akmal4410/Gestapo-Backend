...
type Response struct {
	...
	ErrorInfo  *ErrorInfo `protobuf:"bytes,1,opt,name=error_info,json=errorInfo,proto3" json:"error_info,omitempty"`
...
func (x *Response) GetErrorInfo() *ErrorInfo {
	if x != nil {
		return x.ErrorInfo
	}
	return nil
...
var file_api_proto_common_service_proto_rawDesc = []byte{
	...
	0x12, 0x02, 0x70, 0x62, 0x1a, 0x1a, 0x61, 0x70, 0x69, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f,
	0x65, 0x72, 0x72, 0x6f, 0x72, 0x5f, 0x69, 0x6e, 0x66, 0x6f, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	0x22, 0x8b, 0x01, 0x0a, 0x08, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x2c, 0x0a,
	0x0a, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x5f, 0x69, 0x6e, 0x66, 0x6f, 0x18, 0x01, 0x20, 0x01, 0x28,
	0x0b, 0x32, 0x0d, 0x2e, 0x70, 0x62, 0x2e, 0x45, 0x72, 0x72, 0x6f, 0x72, 0x49, 0x6e, 0x66, 0x6f,
	0x52, 0x09, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x49, 0x6e, 0x66, 0x6f, 0x12, 0x1f, 0x0a, 0x0b, 0x73,
	...
	0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x42, 0x0b,
...
var file_api_proto_common_service_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_api_proto_common_service_proto_goTypes = []interface{}{
	(*Response)(nil),  // 0: pb.Response
	(*ErrorInfo)(nil), // 1: pb.ErrorInfo
}
var file_api_proto_common_service_proto_depIdxs = []int32{
	1, // 0: pb.Response.error_info:type_name -> pb.ErrorInfo
...
func file_api_proto_common_service_proto_init() {
	...
	file_api_proto_error_info_proto_init()
	if !protoimpl.UnsafeEnabled {
