...
func (handler *merchantService) InsertProduct(w http.ResponseWriter, r *http.Request) {
	const (
		thirtyTwoMB      = 32 << 20
		maxFileCount int = 5
	)
...
// func (handler *merchantService) EditProduct(w http.ResponseWriter, r *http.Request) {
// 	const (
// 		thirtyTwoMB      = 32 << 20
// 		maxFileCount int = 5
// 	)
